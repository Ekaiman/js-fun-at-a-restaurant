...
var stockCount = 10
  if (stockCount >= 1){
  console.log("i'm going to eat some " + food + "'s");
} else {
  console.log(`We need to get some more ${food}s`);
}
...
// the "food" variable should be included in the logged statement.
  ...
  if (isFavorite == true){
    ...
    console.log(`I recently ate ${type}`);
  }
...
var vegetables = ["broccoli", "asparagus", "carrot", "corn", "peas"];
...
var fruits = ["apple", "banana", "pear", "grape", "avocado", "mango", "strawberry",];
